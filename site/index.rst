...
.. plot::
   ...
   import siteUtils
   import commonUtils
   siteUtils.showYearHistogramForFileList(commonUtils.loadFileListPlusPrefix('{{ fileListName }}', '{{ pathPrefix }}'))
...
.. plot::
   ...
   import siteUtils
   import commonUtils
   siteUtils.showTop2GramsForFileList(commonUtils.loadFileListPlusPrefix('{{ fileListName }}', '{{ pathPrefix }}'))
...
.. plot::
   ...
   import siteUtils
   import commonUtils
   siteUtils.showTopNGramsForFileList(commonUtils.loadFileListPlusPrefix('{{ fileListName }}', '{{ pathPrefix }}'))
...
.. plot::
   ...
   import siteUtils
   import commonUtils
   siteUtils.show5HexagramsForFileList(commonUtils.loadFileListPlusPrefix('{{ fileListName }}', '{{ pathPrefix }}'))
